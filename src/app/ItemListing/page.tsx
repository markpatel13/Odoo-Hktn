...
import { Search, ChevronLeft, ChevronRight, Heart, Share2, Star, MapPin, Clock, ShoppingBag, MessageCircle, User } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="flex items-center justify-between mb-4">
                <span className="text-2xl font-bold text-blue-600">{product.swapValue}</span>
              ...
              <div className="flex space-x-3">
                ...
                <button className="flex-1 bg-gray-100 text-gray-700 py-3 px-6 rounded-xl font-semibold hover:bg-gray-200 transition-all duration-200">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <button className="bg-blue-100 text-blue-600 px-4 py-2 rounded-lg font-medium hover:bg-blue-200 transition-all duration-200">
